...
import org.hubert.springboot.mysql57.mybatis.annotation.dao.provider.UserDaoProvider;
    ...
    @Results(
            ...
            value = {
                    ...
                    @Result(property = "roles", column = "id",
                            many = @Many(
                                    select = "org.hubert.springboot.mysql57.mybatis.annotation.dao.RoleDao.findRoleByUserId",
