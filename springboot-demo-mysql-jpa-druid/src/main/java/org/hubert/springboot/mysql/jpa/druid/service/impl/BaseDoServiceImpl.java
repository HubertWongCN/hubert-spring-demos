...
import org.hubert.springboot.mysql.jpa.druid.entity.BaseEntity;
import org.hubert.springboot.mysql.jpa.druid.service.BaseService;
...
@Slf4j
@Transactional
public abstract class BaseDoServiceImpl<T extends BaseEntity, I extends Serializable> implements BaseService<T, I> {
