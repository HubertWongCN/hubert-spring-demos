...
import org.hubert.springboot.ratelimit.guava.config.exception.BusinessException;
...
public class RateLimitAspect {
    ...
    @Pointcut("@annotation(org.hubert.springboot.ratelimit.guava.config.ratelimit.RateLimit)")
